...
- on tweak is that we would also like toggle ai commit and toggle demon on the dashboard page, proper buttons at the bottom i guess, also status hub should show the daemon watched folder
