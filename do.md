...
-   graph scren could use submenus to switch between main/master , current , and all branches, maybe if there are a ton of branch it would be broken, so just let us select a 